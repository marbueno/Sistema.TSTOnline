...
namespace Sistema.TSTOnline.Data
{
    public class DataBaseContext : DbContext
    {
        ...
        public DbSet<ContasReceberGrid> ContasReceberGrid { get; set; }
        public DbSet<FluxoCaixaEN> tbfluxocaixa { get; set; }
        public DbSet<FluxoCaixaGrid> FluxoCaixaGrid { get; set; }
        ...
        public DbSet<OrdemServicoPorTecnicoEN> OrdemServicoPorTecnico { get; set; }
        public DbSet<OrdemServicoPorClienteEN> OrdemServicoPorCliente { get; set; }
